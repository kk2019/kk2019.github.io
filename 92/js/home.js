    ...
    function DownSoft() {
	   ...
	   if(iphoneos) {
            if(typeof isCompany != 'undefined') {
                if(isCompany === '1') {
                    window.location.href = './install.html?v30';
                    return;
                }
            }
        }

        window.location.href='https://zuiniubi.oss-cn-shenzhen.aliyuncs.com/20180821/cn_xinhao_online_appid227_ver260_20180821.apk';
